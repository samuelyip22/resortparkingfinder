...
export const resorts = [
  {
    ...
    // Webcams — each has a name and embed/iframe URL
    webcams: [
      { name: "Hidden Peak", url: "https://www.snowbird.com/webcams/hidden-peak/" },
      { name: "Peruvian Gulch", url: "https://www.snowbird.com/webcams/peruvian-gulch/" },
      { name: "Tram Base", url: "https://www.snowbird.com/webcams/tram-base/" },
    ],

    // Trail map image (static image shown on detail page)
...

  {
    ...
    webcams: [
      { name: "Albion Base", url: "https://www.alta.com/webcams" },
      { name: "Wildcat Base", url: "https://www.alta.com/webcams" },
    ],
...

  {
    ...
    webcams: [
      { name: "Village Webcam", url: "https://www.brightonresort.com/mountain/webcams/" },
      { name: "Millicent", url: "https://www.brightonresort.com/mountain/webcams/" },
    ],
...

  {
    ...
    webcams: [
      { name: "Village Webcam", url: "https://www.solitudemountain.com/the-mountain/webcams/" },
      { name: "Summit Webcam", url: "https://www.solitudemountain.com/the-mountain/webcams/" },
    ],
...

  {
    ...
    webcams: [
      { name: "Snow Park Lodge", url: "https://www.deervalley.com/the-mountain/webcams" },
      { name: "Silver Lake Lodge", url: "https://www.deervalley.com/the-mountain/webcams" },
      { name: "Empire Canyon", url: "https://www.deervalley.com/the-mountain/webcams" },
    ],
    ...
    heroImage: "/images/deer-valley.jpg",
    heroColor: "#3a2a1e",
  },

  {
    ...
    webcams: [
      { name: "Earl's Lodge Base", url: "https://www.snowbasin.com/the-mountain/webcams/" },
      { name: "Summit", url: "https://www.snowbasin.com/the-mountain/webcams/" },
      { name: "Strawberry Express", url: "https://www.snowbasin.com/the-mountain/webcams/" },
    ],
    ...
    heroImage: "/images/snowbasin.jpg",
    heroColor: "#1a3a2a",
  },

  {
    ...
    webcams: [
      { name: "Mountain Village Base", url: "https://www.parkcitymountain.com/the-mountain/webcams/" },
      { name: "Canyons Village", url: "https://www.parkcitymountain.com/the-mountain/webcams/" },
    ],
    ...
    heroImage: "/images/park-city.jpg",
    heroColor: "#3a1a1a",
  },
]
